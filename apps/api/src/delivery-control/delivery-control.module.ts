 ...
 * 当前为骨架阶段 —— 提供 SecurityGate、ExecutorRouter、DeliveryMessage，尚未接入主交付流程。
 * 后续按 docs/architecture/EVOLUTION_PLAN.md 逐步填充并灰度接入。
 */
@Module({
  providers: [SecurityGateService, ExecutorRouterService, DeliveryMessageService],
  exports: [SecurityGateService, ExecutorRouterService, DeliveryMessageService],
})
